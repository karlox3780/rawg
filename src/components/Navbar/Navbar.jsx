    ...
    return (
        <>
            <header className='relative flex items-center gap-5 bg-transparent z-10 py-[24px] px-[40px] max-md:px-[15px]'>
                ...
                <button onClick={handleShowNavbar} type="button" className="inline-flex items-center p-2 w-10 h-10 justify-center text-sm text-gray-500 rounded-lg md:hidden hover:bg-[hsla(0,0%,100%,.2)] focus:outline-none focus:ring-2 focus:ring-[hsla(0,0%,100%,.2)] dark:text-[hsla(0,0%,100%,.2)] dark:hover:bg-[hsla(0,0%,100%,.2)] dark:focus:ring-[hsla(0,0%,100%,.2)]" aria-controls="navbar-default" aria-expanded="false">
